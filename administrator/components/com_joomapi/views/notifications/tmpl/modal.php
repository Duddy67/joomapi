...
JHtml::_('formbehavior.chosen', '.multipleUsers',null, array('placeholder_text_multiple' => JText::_('COM_JOOMAPIS_SELECT_CREATOR')));
...
require_once JPATH_ROOT.'/components/com_joomapi/helpers/route.php';
...
$function = $jinput->get('function', 'selectNotification');
$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn  = $this->escape($this->state->get('list.direction'));
?>

<form action="<?php echo JRoute::_('index.php?option=com_joomapi&view=notifications&layout=modal&tmpl=component&function='.$function.'&'.JSession::getFormToken().'=1');?>" method="post" name="adminForm" id="adminForm" class="form-inline">
